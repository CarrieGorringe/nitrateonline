...
<frameset framespacing="0" border="0" cols="152,*" frameborder="0">
  ...
  <frame name="right" src="http://www.amazon.com/exec/obidos/external-search?mode=dvd&tag=nitrateonline&keyword=<% = szQueryPlus %>" scrolling="auto" marginwidth="0" marginheight="0" target="_self">
  <noframes>

<!--webbot bot="Include" U-Include="storeitm/storeitmnf.htm" TAG="BODY" startspan -->
...
<!--webbot bot="Include" endspan i-checksum="24709" -->
